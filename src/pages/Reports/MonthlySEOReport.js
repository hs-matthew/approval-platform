...
export default function MonthlySEOReport() {
  ...
  // Base state seeded from mock + header overrides (if present)
  const [reportData, setReportData] = useState({
    ...mockMonthlyData,
    month: header?.monthLabel || mockMonthlyData.month,
          ...
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4">
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-600 mb-3">
                Upload a CSV with columns: Task, Credits, Type, Deliverable Link, Deliverable Type, Date Completed, Description
              </p>
